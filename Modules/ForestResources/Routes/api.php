...
Route::get('/development_units/export', 'DevelopmentUnitController@export');
...
Route::get('/annual_allowable_cuts/export', 'AnnualAllowableCutController@export');
...
Route::get('/annual_allowable_cut_inventory/export', 'AnnualAllowableCutInventoryController@export');
