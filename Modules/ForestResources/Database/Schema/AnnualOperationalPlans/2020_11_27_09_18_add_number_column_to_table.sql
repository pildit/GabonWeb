...
create or replace view "ForestResources"."AnnualOperationPlans"
            ("Id", "AnnualAllowableCut", "Number", "Species", "ExploitableVolume", "NonExploitableVolume", "VolumePerHectare",
             "AverageVolume", "TotalVolume", "Approved", "CreatedAt", "UpdatedAt", "DeletedAt")
as
SELECT aopt."Id",
...
CREATE RULE "AnnualOperationPlans_instead_of_insert" AS
    ON INSERT TO "ForestResources"."AnnualOperationPlans" DO INSTEAD
    INSERT INTO "ForestResources"."AnnualOperationPlansTable" ("Id",
                                                                "AnnualAllowableCut",
                                                                "Number",
                                                                "Species",
                                                                "ExploitableVolume",
     ...
     VALUES (nextval('"ForestResources"."SEQ_AnnualOperationPlans"'::regclass),
             new."AnnualAllowableCut", new."Number", new."Species",
     ...
     RETURNING "AnnualOperationPlansTable"."Id",
         "AnnualOperationPlansTable"."AnnualAllowableCut",
         "AnnualOperationPlansTable"."Number",
         "AnnualOperationPlansTable"."Species",
         "AnnualOperationPlansTable"."ExploitableVolume",
         "AnnualOperationPlansTable"."NonExploitableVolume",
         "AnnualOperationPlansTable"."VolumePerHectare",
         "AnnualOperationPlansTable"."AverageVolume",
         "AnnualOperationPlansTable"."TotalVolume",
         "AnnualOperationPlansTable"."Approved",
         "AnnualOperationPlansTable"."CreatedAt",
         "AnnualOperationPlansTable"."UpdatedAt",
         "AnnualOperationPlansTable"."DeletedAt";

CREATE RULE "AnnualOperationPlans_instead_of_update" AS
    ON UPDATE TO "ForestResources"."AnnualOperationPlans" DO INSTEAD
