CREATE OR REPLACE VIEW "ForestResources"."AnnualAllowableCutInventory"
            ("Id", "AnnualAllowableCut", "AnnualAllowableCutName", "Species", "SpeciesCommonName", "Quality", "Parcel",
             "ParcelName", "TreeId", "DiameterBreastHeight", "Geometry", "Lat", "Lon", "GpsAccu", "User", "Email",
             "Approved", "MobileId", "ObserveAt", "CreatedAt", "UpdatedAt", "DeletedAt")
as
SELECT aacit."Id",
...
CREATE OR REPLACE RULE "AnnualAllowableCutInventory_instead_of_insert" AS
    ON INSERT TO "ForestResources"."AnnualAllowableCutInventory" DO INSTEAD INSERT INTO "ForestResources"."AnnualAllowableCutInventoryTable" ("Id",
                                                                            ...
                                                                            RETURNING "AnnualAllowableCutInventoryTable"."Id", "AnnualAllowableCutInventoryTable"."AnnualAllowableCut", (SELECT aac."Name"
                                                                                                                                                                                         FROM "ForestResources"."AnnualAllowableCutsTable" aac
                                                                                                                                                                                         WHERE "AnnualAllowableCutInventoryTable"."AnnualAllowableCut" = aac."Id"
                                                                                                                                                                                         LIMIT 1) AS annualallowablecutname, "AnnualAllowableCutInventoryTable"."Species", (SELECT s."CommonName"
                                                                                                                                                                                                                                                                            FROM "Taxonomy"."SpeciesTable" s
                                                                                                                                                                                                                                                                            WHERE "AnnualAllowableCutInventoryTable"."Species" = s."Id"
                                                                                                                                                                                                                                                                            LIMIT 1) AS "SpeciesCommonName", "AnnualAllowableCutInventoryTable"."Quality", "AnnualAllowableCutInventoryTable"."Parcel", (SELECT p."Name"
                                                                                                                                                                                                                                                                                                                                                                                                         FROM "ForestResources"."ParcelsTable" p
                                                                                                                                                                                                                                                                                                                                                                                                         WHERE "AnnualAllowableCutInventoryTable"."Parcel" = p."Id"
                                                                                                                                                                                                                                                                                                                                                                                                         LIMIT 1) AS "ParcelName", "AnnualAllowableCutInventoryTable"."TreeId", "AnnualAllowableCutInventoryTable"."DiameterBreastHeight", "AnnualAllowableCutInventoryTable"."Geometry", "AnnualAllowableCutInventoryTable"."Lat", "AnnualAllowableCutInventoryTable"."Lon", "AnnualAllowableCutInventoryTable"."GpsAccu", "AnnualAllowableCutInventoryTable"."User", (SELECT acc.email
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        FROM admin.accounts acc
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        WHERE "AnnualAllowableCutInventoryTable"."User" = acc.id
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        LIMIT 1) AS "Email", "AnnualAllowableCutInventoryTable"."Approved", "AnnualAllowableCutInventoryTable"."MobileId", "AnnualAllowableCutInventoryTable"."ObserveAt", "AnnualAllowableCutInventoryTable"."CreatedAt", "AnnualAllowableCutInventoryTable"."UpdatedAt", "AnnualAllowableCutInventoryTable"."DeletedAt";

CREATE OR REPLACE RULE "AnnualAllowableCutInventory_instead_of_update" AS
