...
group by du."Id", du."Name", du."Concession", con."Name", du."Start", du."End", du."Geometry", du."Approved", du."Number", du."User", acc.email, du."ProductType", du."CreatedAt", du."UpdatedAt", du."DeletedAt";
