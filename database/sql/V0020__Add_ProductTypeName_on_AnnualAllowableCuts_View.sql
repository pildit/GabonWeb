...
group by aac."Id", aac."Name", aac."AacId", aac."ManagementUnit", mu."Name", aac."ManagementPlan", aac."Geometry", aac."ProductType", pt."Name", aac."User", acc.email, aac."Approved", aac."CreatedAt", aac."UpdatedAt", aac."DeletedAt";
