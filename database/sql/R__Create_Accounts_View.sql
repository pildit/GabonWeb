...
CREATE RULE "accounts_instead_of_delete" AS
    ON DELETE TO "admin"."Accounts" DO INSTEAD
    DELETE
    FROM "admin"."accounts"
    WHERE "accounts"."id" = old."id";

CREATE RULE "accounts_insted_of_insert" AS
...
CREATE RULE "accounts_instead_of_update" AS
