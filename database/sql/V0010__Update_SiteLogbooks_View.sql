...
create or replace view "ForestResources"."SiteLogbooks"
            ("Id", "AnnualAllowableCut", "AnnualAllowableCutName", "ManagementUnit", "ManagementUnitName", "DevelopmentUnit", "DevelopmentUnitName", "Concession",
             "ConcessionName", "Company", "CompanyName", "Hammer", "Localization", "ReportNo", "ReportNote",
             "ObserveAt", "Approved", "MobileId", "CreatedAt", "UpdatedAt", "DeletedAt")
as
SELECT slb."Id",
...
CREATE RULE "SiteLogbooks_instead_of_insert" AS
    ...
    DO INSTEAD INSERT INTO "ForestResources"."SiteLogbooksTable" ("Id",
                                                                  "AnnualAllowableCut",
                                                                  "ManagementUnit",
                                                                  "DevelopmentUnit",
                                                                  "Concession",
               ...
               VALUES (nextval('"ForestResources"."SEQ_SiteLogbooksTable"'::regclass),
                       ...
                       new."CreatedAt")
               RETURNING "SiteLogbooksTable"."Id",
                   "SiteLogbooksTable"."AnnualAllowableCut",
                   (SELECT aac."Name"
                   ...
                   "SiteLogbooksTable"."ManagementUnit",
                   (select mu."Name" from "ForestResources"."ManagementUnitsTable" mu where "SiteLogbooksTable"."ManagementUnit" = mu."Id" limit 1),
                   "SiteLogbooksTable"."DevelopmentUnit",
                   (select du."Name" from "ForestResources"."DevelopmentUnitsTable" du where "SiteLogbooksTable"."DevelopmentUnit" = du."Id" limit 1),
                   "SiteLogbooksTable"."Concession",
                   (SELECT con."Name"
                   ...
                   "SiteLogbooksTable"."Hammer",
                   "SiteLogbooksTable"."Localization",
                   "SiteLogbooksTable"."ReportNo",
                   "SiteLogbooksTable"."ReportNote",
                   "SiteLogbooksTable"."ObserveAt",
                   "SiteLogbooksTable"."Approved",
                   "SiteLogbooksTable"."MobileId",
                   "SiteLogbooksTable"."CreatedAt",
                   "SiteLogbooksTable"."UpdatedAt",
                   "SiteLogbooksTable"."DeletedAt";
