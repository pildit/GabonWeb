...
create or replace view "Transportation"."Permits"
            ...
            "DevelopmentUnit", "DevelopmentUnitName", "AnnualAllowableCut", "AnnualAllowableCutName", "ClientCompany", "ClientCompanyName",
...
SELECT per."Id",
       ...
       per."ManagementUnit",
       mu."Name" as "MangementUnitName",
       per."DevelopmentUnit",
       du."Name" as "DevelopmentUnit",
