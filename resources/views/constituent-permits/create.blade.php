    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-8 mt-4" id="constituent-permit-form">
                <constituent-permit-form endpoint-create="constituent-permit-create" endpoint-edit="constituent-permit-edit" style="overflow-x: scroll"></constituent-permit-form>
            </div>
        </div>
    </div>
@endsection
