        ...
        <div class="row">
            <div class="col-md-4">
                <div id="sidemap" class="col-md-4" style="position: fixed; padding: 10px">
                    <side-map endpoint-name="concessions-create"></side-map>
                </div>
            </div>
            <div class="col-md-8 mt-4" id="concessions-form">
                <concessions-form style="overflow-x: scroll" v-permission="'concession.add'" endpoint-name="concessions-create"></concessions-form>
            </div>
        </div>
    </div>
@endsection
