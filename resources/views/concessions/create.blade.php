    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-8 mt-4" id="concessions-form">
                <concessions-form endpoint-create="concessions-create" endpoint-edit="concessions-edit" style="overflow-x: scroll" v-permission="'concession.add'"></concessions-form>
            </div>
        </div>
    </div>
@endsection
